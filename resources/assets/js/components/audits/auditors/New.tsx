...
class NewAuditor extends React.PureComponent<IProps> {
...
const mapDispatchToProps = (dispatch: any): IDispatchProps => {
  return {
    registrationAuditorUser: (form: HTMLFormElement) => dispatch(registrationAuditorUser(form)),
  };
};

export const NewAuditorContainer = connect(mapStateToProps, mapDispatchToProps)(NewAuditor);
