                        ...
                        <Col xs="12" lg="12">
                            <Card>
                                <CardHeader>
                                    ...
                                    Сотрудники «{legalEntity.name}» с просроченным медицинским осмотром
                                    ({this.props.employeesResearchesExpired.length})
                                ...
                                <CardBlock className="card-body">
                                    <Table responsive>
                                        ...
                                        <tbody>
                                        { this.props.employeesResearchesExpired.map((employee) => {
                                            return (
                                                <tr key={employee.id}>
                                                    <td>
