...
<body id="page-top" data-scroll-animation="true">
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2">
                            <div class="feat-description text-center">
                                <h4 class="text-muted">Sed risus feugiat fusce eu sit.</h4>
                                <p class="text-muted">Sed risus feugiat fusce eu sit conubia venenatis aliquet nisl cras eu
                                    adipiscing ac cras at sem cras per senectus eu parturient quam. Sed risus feugiat fusce
                                    eu sit conubia venenati.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2">
                            <div class="feat-description text-center">
                                ...
                                <p class="text-muted">Sed risus feugiat fusce eu sit conubia venenatis aliquet nisl cras eu
                                    adipiscing ac cras at sem cras per senectus eu parturient quam. Sed risus feugiat fusce
                                    eu sit conubia venenatis aliquet nisl cras eu.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="splash splash--gray">
        ...
        <a href="/#/login" class="btn btn-rect btn-xl btn-rect--white">РЕГИСТРАЦИЯ</a>
    </section>
